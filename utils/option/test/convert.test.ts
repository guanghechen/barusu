...
describe('convert', function () {
  describe('convertToBoolean', function () {
    it('`true` ==> true', () => expect(convertToBoolean(true)).to.equal(true))
    it('`false` ==> false', () =>
    ...
    it('`0` ==> false', () => expect(convertToBoolean(0)).to.equal(false))
    it('`1` ==> true', () => expect(convertToBoolean(1)).to.equal(true))
    it('`[]` ==> true', () => expect(convertToBoolean([])).to.equal(true))
    it('`{}` ==> true', () => expect(convertToBoolean({})).to.equal(true))
    it("`''` ==> undefined", () => expect(convertToBoolean('')).to.be.undefined)
  })

  describe('convertToNumber', function () {
    it('`0` ==> 0', () => expect(convertToNumber(0)).to.equal(0))
    it('`1` ==> 1', () => expect(convertToNumber(1)).to.equal(1))
    it("`'0'` ==> 0", () => expect(convertToNumber('0')).to.equal(0))
    it("`'1'` ==> 1", () => expect(convertToNumber('1')).to.equal(1))
    it("`'-1'` ==> -1", () => expect(convertToNumber('-1')).to.equal(-1))
    it('`true` ==> undefined', () =>
    ...
    it('`[]` ==> undefined', () => expect(convertToNumber([])).to.be.undefined)
    it('`{}` ==> undefined', () => expect(convertToNumber({})).to.be.undefined)
    it("`''` ==> undefined", () => expect(convertToNumber('')).to.be.undefined)
  })

  describe('convertToString', function () {
    it("`''` ==> ''", () => expect(convertToString('')).to.equal(''))
    it("`-1` ==> '-1'", () => expect(convertToString(-1)).to.equal('-1'))
    it("`true` ==> 'true'", () =>
    ...
    it('`[]` ==> undefined', () => expect(convertToString([])).to.be.undefined)
    it('`{}` ==> undefined', () => expect(convertToString({})).to.be.undefined)
  })
})
