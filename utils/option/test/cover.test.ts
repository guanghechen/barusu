...
describe('cover', function () {
  describe('coverBoolean', function () {
    ...
    it('(false) => true', () => expect(coverBoolean(false)).to.equal(false))
    it('(false, []) => true', () =>
  ...
  describe('coverNumber', function () {
    ...
    it('(3, null) => 3', () => expect(coverNumber(3, null)).to.equal(3))
    it('(3, 0) => 0', () => expect(coverNumber(3, 0)).to.equal(0))
    it('(3, true) => 3', () => expect(coverNumber(3, true)).to.equal(3))
    it('(3, false) => 3', () => expect(coverNumber(3, false)).to.equal(3))
    it('(3, []) => 3', () => expect(coverNumber(3, [])).to.equal(3))
    it('(3, {}) => 3', () => expect(coverNumber(3, {})).to.equal(3))
    it("(3, '5') => 5", () => expect(coverNumber(3, '5')).to.equal(5))
    it("(3, '') => 3", () => expect(coverNumber(3, '')).to.equal(3))
  })
  ...
  describe('coverString', function () {
    ...
    it("('x', null) => 'x'", () => expect(coverString('x', null)).to.equal('x'))
    it("('x', 'y') => 'y'", () => expect(coverString('x', 'y')).to.equal('y'))
    it("('x', 0) => '0'", () => expect(coverString('x', 0)).to.equal('0'))
    it("('x', []) => 'x'", () => expect(coverString('x', [])).to.equal('x'))
    it("('x', {}) => 'x'", () => expect(coverString('x', {})).to.equal('x'))
    it("('x', true) => 'x'", () =>
