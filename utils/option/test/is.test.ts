...
describe('is', function () {
  describe('isUndefined', function () {
    ...
    it('`null` is not undefined', () => expect(isUndefined(null)).to.be.false)
    it('`false` is not undefined', () => expect(isUndefined(false)).to.be.false)
    it('`0` is not undefined', () => expect(isUndefined(0)).to.be.false)
  ...
  describe('isBoolean', function () {
    it('`false` is a boolean type', () => expect(isBoolean(false)).to.be.true)
    it('`true` is a boolean type', () => expect(isBoolean(true)).to.be.true)
  ...
  describe('isNumber', function () {
    it('`0` is a number', () => expect(isNumber(0)).to.be.true)
    it('`1` is a number', () => expect(isNumber(1)).to.be.true)
    it('`-1` is a number', () => expect(isNumber(-1)).to.be.true)
    it('`-1.0234` is a number', () => expect(isNumber(-1.0234)).to.be.true)
    it("new Number(`'1')` is a number", () =>
      expect(isNumber(new Number('-1'))).to.be.true)
    it("`'1'` is not a number", () => expect(isNumber('1')).to.be.false)
    it('`undefined` is not a number', () =>
      expect(isNumber(undefined)).to.be.false)
    it('`null` is not a number', () => expect(isNumber(null)).to.be.false)
    it('empty string is not a number', () => expect(isNumber('')).to.be.false)
    it('empty array is not a number', () => expect(isNumber([])).to.be.false)
    it('empty object is not a number', () => expect(isNumber({})).to.be.false)
    it('bigint is not a number', () =>
      expect(isNumber(BigInt(233))).to.be.false)
  })

  describe('isString', function () {
    it("`'x'` is a string", () => expect(isString('x')).to.be.true)
    it('`new String(1)` is a string', () =>
      expect(isString(new String(1))).to.be.true)
    it('`undefined` is not a string', () =>
      expect(isString(undefined)).to.be.false)
    it('`null` is not a string', () => expect(isString(null)).to.be.false)
    it('empty string is a string', () => expect(isString('')).to.be.true)
    it('empty array is not a string', () => expect(isString([])).to.be.false)
    it('empty object is not a string', () => expect(isString({})).to.be.false)
  })

  describe('isBigint', function () {
    it('`BigInt(0)` is a bigint', () => expect(isBigint(BigInt(0))).to.be.true)
    it('`0` is not a bigint', () => expect(isBigint(0)).to.be.false)
    it('`undefined` is not a bigint', () =>
      expect(isBigint(undefined)).to.be.false)
    it('`null` is not a bigint', () => expect(isBigint(null)).to.be.false)
    it('empty string is not a bigint', () => expect(isBigint('')).to.be.false)
    it('empty array is not a bigint', () => expect(isBigint([])).to.be.false)
    it('empty object is not a bigint', () => expect(isBigint({})).to.be.false)
  })
  ...
  describe('isSymbol', function () {
    ...
    it('`null` is not a symbol', () => expect(isSymbol(null)).to.be.false)
    it('literal string is not a symbol', () =>
      expect(isSymbol('x')).to.be.false)
    it('empty array is not a symbol', () => expect(isSymbol([])).to.be.false)
    it('empty object is not a symbol', () => expect(isSymbol({})).to.be.false)
  })

  describe('isInteger', function () {
    it('`-1` is a integer', () => expect(isInteger(-1)).to.be.true)
    it("new Number(`'1')` is a integer", () =>
      expect(isInteger(new Number('-1'))).to.be.true)
    it('`1.000` is not a integer', () => expect(isInteger(1.0)).to.be.true)
    it('`1.002` is not a integer', () => expect(isInteger(1.002)).to.be.false)
    it('`undefined` is not a integer', () =>
      expect(isInteger(undefined)).to.be.false)
    it('`null` is not a integer', () => expect(isInteger(null)).to.be.false)
    it('literal string is not a integer', () =>
      expect(isInteger('x')).to.be.false)
    it('empty array is not a integer', () => expect(isInteger([])).to.be.false)
    it('empty object is not a integer', () => expect(isInteger({})).to.be.false)
  ...
  describe('isArray', function () {
    ...
    it('`null` is not an array', () => expect(isArray(null)).to.be.false)
    it('string is not an array', () => expect(isArray('x')).to.be.false)
    it('empty object is not an array', () => expect(isArray({})).to.be.false)
    it('empty array is an array', () => expect(isArray([])).to.be.true)
  ...
  describe('isFunction', function () {
    ...
    it('`null` is not a function', () => expect(isFunction(null)).to.be.false)
  })
  ...
  describe('isPrimitiveInteger', function () {
    ...
    it('`1.000` is not a primitive integer', () =>
      expect(isPrimitiveInteger(1.0)).to.be.true)
  ...
  describe('isNumberLike', function () {
    it('`0` is a number like', () => expect(isNumberLike(0)).to.be.true)
    it('`1` is a number like', () => expect(isNumberLike(1)).to.be.true)
    it('`-1` is a number like', () => expect(isNumberLike(-1)).to.be.true)
    ...
    it("`'1'` is a number like", () => expect(isNumberLike('1')).to.be.true)
    it("`'1x'` is a number like", () => expect(isNumberLike('1x')).to.be.false)
