 ...
 */
export const processSubCommandEncrypt: SubCommandProcessor<SubCommandEncryptOptions, void> =
  async function (
...
export const mountSubCommandEncrypt: SubCommandMounter =
  createSubCommandMounter<SubCommandEncryptOptions, void>(
    createSubCommandEncrypt,
 ...
 * @returns {Promise}
 */
export const execSubCommandEncrypt: SubCommandExecutor<void>
  = createSubCommandExecutor<SubCommandEncryptOptions, void>(
    createSubCommandEncrypt,
    processSubCommandEncrypt,
  )
