 ...
 */
export const processSubCommandEncrypt: SubCommandProcessor<SubCommandEncryptOptions> = async function (
 ...
 * @returns {void}
 */
export const mountSubCommandEncrypt: SubCommandMounter = createSubCommandMounter<SubCommandEncryptOptions>(
  createSubCommandEncrypt,
 ...
 * @returns {Promise}
 */
export const execSubCommandEncrypt: SubCommandExecutor = createSubCommandExecutor<SubCommandEncryptOptions>(
  createSubCommandEncrypt,
  processSubCommandEncrypt,
)
